...
function get_all_item($accountId,$description,$salesProductId) 
{
    global $conn;
    $q['query'] ="SELECT salesProductId,salesProductName, sizeName, price FROM sales_product_prices WHERE accountId ='$accountId'AND salesProductId='$salesProductId' ORDER BY CASE sizeName WHEN 'Baby' THEN 0 WHEN 'Small/Default' THEN 1 WHEN 'Medium' THEN 2 WHEN 'Large' THEN 3 END";
...
$data = get_all_item($accountId,$description,$salesProductId);
if($data)
{
