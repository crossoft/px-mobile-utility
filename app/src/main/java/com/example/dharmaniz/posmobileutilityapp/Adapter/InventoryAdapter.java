...
public class InventoryAdapter extends RecyclerView.Adapter<InventoryAdapter.ViewWorkHolder> {
    ...
    @Override
    public InventoryAdapter.ViewWorkHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_show_name, parent, false);
        return new InventoryAdapter.ViewWorkHolder(itemView);
    }

    @Override
    public void onBindViewHolder(InventoryAdapter.ViewWorkHolder holder, int position) {
