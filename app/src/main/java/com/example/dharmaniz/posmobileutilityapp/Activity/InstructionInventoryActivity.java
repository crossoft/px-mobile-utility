...
import com.example.dharmaniz.posmobileutilityapp.Adapter.InstructionAdapter;
import com.example.dharmaniz.posmobileutilityapp.Models.InstructionModel;
...
public class InstructionInventoryActivity extends PostMobileBaseActivity {
    Activity mActivity =InstructionInventoryActivity.this;

    private TextView nodataTV;
    private RelativeLayout backRL,homeRL;
    private RecyclerView innventoryRV;
    InstructionAdapter mAdapter;
    ArrayList<InstructionModel> modelArrayList =  new ArrayList<InstructionModel>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instruction_inventory);
    }
    ...
    protected void setUpViews() {
        ...
        if(Constants.InstructionClick==true){
    ...
    protected void onResume() {
        ...
        if (!Utilities.isNetworkAvailable(mActivity)) {
            ...
            if (!Constants.strSearchText.equals("")) {
                ...
                getSearchSetUpInventoryData(Constants.strSearchText);
            }
        }
    }
    ...
    protected void setUpEvents() {
        ...
        homeRL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Constants.InstructionClick=false;
    ...
    private void getSearchSetUpInventoryData(String strSearchText){
        modelArrayList.clear();
        Utilities.showProgressDialog(mActivity);

        String url = "http://dharmani.com/jspro2/SearchInventoryByInstructions.php";
...
////      Adding request to request queue
        ...
        try {
            if (!responce.getString("status").equals("")) {
                ...
                for (int i = 0; i < mJsonArray.length(); i++) {
                    ...
                    InstructionModel mInventoryModel = new InstructionModel();
    ...
    private void setAdapter() {
        mAdapter = new InstructionAdapter(mActivity, modelArrayList);
