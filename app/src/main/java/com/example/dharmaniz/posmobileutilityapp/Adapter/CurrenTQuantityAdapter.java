...
public class CurrenTQuantityAdapter extends RecyclerView.Adapter<CurrenTQuantityAdapter.ViewWorkHolder> {
    ...
    @Override
    public CurrenTQuantityAdapter.ViewWorkHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_show_name, parent, false);
        return new CurrenTQuantityAdapter.ViewWorkHolder(itemView);
    }

    @Override
    public void onBindViewHolder(CurrenTQuantityAdapter.ViewWorkHolder holder,  int position) {
...
//            if (tempValue.getCalculatedQty().equals("")) {
//                holder.calculatedQtyNameTV.setText("N/A");
//
//            } else {
//                holder.calculatedQtyNameTV.setText(tempValue.getCalculatedQty());
//            }
//            if (tempValue.getReorderQty().equals("")) {
//                holder.reorderQtyNameTV.setText("N/A");
//
//            } else {
//                holder.reorderQtyNameTV.setText(tempValue.getReorderQty());
//            }
//            if (tempValue.getMinLevel().equals("")) {
//                holder.minNameTV.setText("N/A");
//            } else {
//                holder.minNameTV.setText(tempValue.getMinLevel());
//            }
//            if (tempValue.getMaxLevel().equals("")) {
//                holder.maxNameTV.setText("N/A");
//            } else {
//                holder.maxNameTV.setText(tempValue.getMaxLevel());
//            }if (tempValue.getVendorName().equals("")) {
//                holder.vendorNameTV.setText("N/A");
//            } else {
//                holder.vendorNameTV.setText(tempValue.getVendorName());
//            }
        }
