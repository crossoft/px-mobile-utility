...
public class ShowSetupdetailActivity extends PostMobileBaseActivity {
    Activity mActivity = ShowSetupdetailActivity.this;
    ...
    InventoryModel mRecorderModel;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_show_setupdetail);
    }
    ...
    protected void setUpViews() {
        ...
        if (!Utilities.isNetworkAvailable(mActivity)) {
            ...
            if (args != null && args.containsKey("CurrentQTY")) {
                mRecorderModel = (InventoryModel) args.getSerializable("CurrentQTY");
