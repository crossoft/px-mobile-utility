...
{
    global $conn;
    $q['query'] ="SELECT name, primaryZone, primaryBin, secondaryZone, secondaryBin FROM `inventory_products` WHERE accountId='$accountId' AND name like'%$Name%' ORDER BY name ASC ";
